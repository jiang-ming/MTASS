<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataForm0.aspx.cs" Inherits="MTASS.UserForms.DataForm0" %>
<!DOCTYPE html>
<html lang="en-us">
<head runat="server">
...
<form id="form1" runat="server" data-ajax="false">
	...
	<div data-role="page">
		...
		<div data-role="content">
			...
			<p><asp:LinkButton ID="btnAddNew" runat="server" onclick="btnAddNew_Click"  data-role="button" data-theme="a">Add New Record</asp:LinkButton></p>
			<asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlFacility" 
				...
				<ItemTemplate>
					<ul data-role="listview" data-theme="c" data-divider-theme="c" data-inset="true">
						<li data-theme="b"><asp:LinkButton ID="LinkButton1" runat="server" Text='<%# GetSubtypeDisplay(Eval("SubTypeDesc"), Eval("DateCreated")) %>' CommandName="ViewEdit" CommandArgument='<%# Eval("ENTRYUID") %>'></asp:LinkButton></li>
						<li>Manufacturer: <asp:Label ID="Label2" runat="server" Text='<%# Eval("Manufacturer") %>'></asp:Label></li>
						<li>Model#: <asp:Label ID="Label3" runat="server" Text='<%# Eval("Model_Number") %>'></asp:Label></li>
						<li>Last Updated: <asp:Label ID="Label1" runat="server" Text='<%# Eval("TIMESTAMP") %>'></asp:Label></li>
					 </ul>
				</ItemTemplate>
			</asp:Repeater>
	</div>
	...
	<asp:sqldatasource ID="SqlFacility" runat="server" 
	    ...
	    SelectCommand="SELECT * FROM Q_Data0_Join_TypeName WHERE BUILDING_ID=@BUILDING_ID AND SUB_CATEGORY_ID=@SUBCATID ORDER BY DISPLAYORDER">
	    <SelectParameters>
